<?php
/**
 * Static seed data copied from the Next.js catalog.
 *
...
function kiswani_elementor_static_products(): array
{
    static $data = null;
    if ($data === null) {
        $json = <<<'JSON'
...
function kiswani_elementor_static_categories(): array
{
    static $data = null;
    if ($data === null) {
        $json = <<<'JSON'
...
function kiswani_elementor_static_product_map_groups(): array
{
    static $data = null;
    if ($data === null) {
        $json = <<<'JSON'
